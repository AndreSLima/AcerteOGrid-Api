...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SiteRankingController : BaseController, IDisposable
    {
        public SiteRankingController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_SITE_RANKING_C");
