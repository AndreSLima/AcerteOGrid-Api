...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SiteSeasonDriverController : BaseController, IDisposable
    {
        public SiteSeasonDriverController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_SITE_DRIVER_SEASON_C");
