...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SeasonRegisterController : BaseController, IDisposable
    {
        public SeasonRegisterController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_API_REGISTRED_SEASON");
