...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SeasonTeamController : BaseController, IDisposable
    {
        public SeasonTeamController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_API_TEAM_SEASON");
