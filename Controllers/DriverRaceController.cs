...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class DriverRaceController : BaseController, IDisposable
    {
        public DriverRaceController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_API_DRIVER_TEAM_SEASON");
