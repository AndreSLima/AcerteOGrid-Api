...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SeasonDriverController : BaseController, IDisposable
    {
        public SeasonDriverController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_API_DRIVER_SEASON");
