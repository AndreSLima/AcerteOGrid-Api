...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SeasonRaceController : BaseController, IDisposable
    {
        public SeasonRaceController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_API_SEASON_RACE");
