...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SiteSeasonTeamController : BaseController, IDisposable
    {
        public SiteSeasonTeamController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_SITE_TEAM_SEASON_C");
