...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SiteCalendarController : BaseController, IDisposable
    {
        public SiteCalendarController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_SITE_CALENDAR_SEASON_C");
