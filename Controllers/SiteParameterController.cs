...
namespace acerteapi.Controllers
{
    ...
    [ApiController]
    public class SiteParameterController : BaseController, IDisposable
    {
        public SiteParameterController(IConfiguration configuration_) : base(configuration_)
        {
        }
        ...
        {
            base.sqlCommand = new SqlCommand("STP_AOG_SITE_PARAMETER_C");
